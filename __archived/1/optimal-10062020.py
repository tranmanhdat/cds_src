...
class AutoControl(Control):
    ...
    def whereAmI(self):
        ...
        print('[whereAmI]   >> current_route', cf.current_route, ' | run_lidar', cf.run_lidar, ' | signSignal', cf.signSignal, ' | cf.do_detect_sign', cf.do_detect_sign, ' || cf.do_detect_stop_sign', cf.do_detect_stop_sign, '| stopSignal', cf.stopSignal, '| sign_bbox', cf.sign_bbox, ' | lane', cf.lane, ' | imu_angle', cf.imu_angle, ' | turned', cf.turned, ' | speed', cf.speed, ' | angle', cf.angle, ' | fps_count', cf.fps_count)
