...
cf.SPEED_PASS_OBJ = 19 # toc do chay de vuot vat can
...
cf.speed_chuyen_lane = 15 # 13 # toc do de chuyen lane
        ...
        if cf.ready and not cf.pause: # uncomment if call auto_control inside getCenter
            ...
            if cf.start_tick_count is not None:
                if cf.start_tick_count < cf.end_tick_from_start:
                    ...
                    # cf.reduce_speed = -1
                    if cf.start_tick_count % 4 == 1 and self.fixed_speed < cf.MAX_SPEED:
                        self.fixed_speed += 1
