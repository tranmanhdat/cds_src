...
route = {
    'thang': ['right', 'right', 'right', 'left', 'left', 'left', 'left', 'right'],
    'phai': ['right', 'right', 'right', 'left', 'left', 'right', 'right', 'right']
}
...
# init node
rospy.init_node('optimal_trai', anonymous=True, disable_signals=True)
